...
$yourURL = "https://www.uvm.edu/~sathibod/cs008/assignment4.1/form3.php";
            ...
            <form action="<? print $_SERVER['PHP_SELF']; ?>" 
                ...
                <fieldset class="wrapper">
                    ...
                    <fieldset class="intro">
                        ...
                        <fieldset>					
                            <input type="submit" id="btnSubmit" name="Submit" value="Register" 
                                   tabindex="991" class="button">
                        </fieldset>

                        <fieldset>
                            <input type="reset" id="btnReset" name="Reset" value="Reset Form" 
